# Ukraine EMS Tracking API For Golang
Ukraine EMS Tracking API and webhook make it easy to integrate Ukraine EMS Tracking function into your own project. Support APIs Client Libraries for golang

### API key

In order to use this API, you need to generate a Ukraine EMS Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Ukraine EMS Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Ukraine EMS Tracking API](https://www.trackingmore.com/ukraine-ems-tracking.html)  to:

   *   Get Ukraine EMS realtime tracking info of muti-carriers in one integration
   *   Provide Ukraine EMS shipment tracking experience like Amazon
   *   Push Ukraine EMS notifications of package update with webhook
   *   Verify Ukraine EMS delivery exception before it is too late
